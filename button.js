...
const buttonMobile = document.querySelector('#dark-mode-toggle-mobile');
let darkMode = true;
...
button === null || button === void 0 ? void 0 : button.addEventListener('click', () => toggleDarkMode(false));
buttonMobile === null || buttonMobile === void 0 ? void 0 : buttonMobile.addEventListener('click', () => toggleDarkMode(true));
